...
default_raw_binary_vector_row, default_binary_entity_row = (
...
default_raw_binary_vectors_new, default_binary_entities_new = (
    utils.gen_binary_entities_new(utils.default_nb)
)

default_entities_rows = utils.gen_entities_rows(utils.default_nb)
default_raw_binary_vectors_rows, default_binary_entities_rows = (
