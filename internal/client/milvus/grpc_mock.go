...
// GetReplicas provides a mock function for the type MockGrpc
func (_mock *MockGrpc) GetReplicas(ctx context.Context, db string, collName string) (*milvuspb.GetReplicasResponse, error) {
	ret := _mock.Called(ctx, db, collName)
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string) (*milvuspb.GetReplicasResponse, error)); ok {
		return returnFunc(ctx, db, collName)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string) *milvuspb.GetReplicasResponse); ok {
		r0 = returnFunc(ctx, db, collName)
	} else {
		if ret.Get(0) != nil {
...
// MockGrpc_GetReplicas_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetReplicas'
type MockGrpc_GetReplicas_Call struct {
	*mock.Call
}
...
//   - db string
//   - collName string
func (_e *MockGrpc_Expecter) GetReplicas(ctx interface{}, db interface{}, collName interface{}) *MockGrpc_GetReplicas_Call {
	return &MockGrpc_GetReplicas_Call{Call: _e.mock.On("GetReplicas", ctx, db, collName)}
}

func (_c *MockGrpc_GetReplicas_Call) Run(run func(ctx context.Context, db string, collName string)) *MockGrpc_GetReplicas_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockGrpc_GetReplicas_Call) Return(getReplicasResponse *milvuspb.GetReplicasResponse, err error) *MockGrpc_GetReplicas_Call {
	_c.Call.Return(getReplicasResponse, err)
	return _c
}

func (_c *MockGrpc_GetReplicas_Call) RunAndReturn(run func(ctx context.Context, db string, collName string) (*milvuspb.GetReplicasResponse, error)) *MockGrpc_GetReplicas_Call {
	_c.Call.Return(run)
	return _c
}
