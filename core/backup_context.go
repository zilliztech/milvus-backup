...
func (b BackupContext) LoadBackup(ctx context.Context, request *backuppb.LoadBackupRequest) (*backuppb.LoadBackupResponse, error) {
	...
	if request.Async {
		...
		go b.doLoadBackup(ctx, request, id)
		return resp, nil
	} else {
		return b.doLoadBackup(ctx, request, id)
	}
...
func (b BackupContext) doLoadBackup(ctx context.Context, request *backuppb.LoadBackupRequest, id int64) (*backuppb.LoadBackupResponse, error) {
